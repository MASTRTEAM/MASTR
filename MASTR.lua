...
sudo_users = {SUDO,332581832,665877797,909438744}   
...
if text =="رسائلي اليوم" then
send(msg.chat_id_, msg.id_,'💌┇  عدد رسائلك هنا » { '..database:get(bot_id..'Msg_User'..os.date('%d')..msg.chat_id_..':'..msg.sender_user_id_)..'}' ) 
end 
...
if not database:get(bot_id..'lock:skrafa'..msg.chat_id_)  then
database:del(bot_id..'lock:skrafa'..msg.chat_id_) 
Text = '\n🚫┋ تم تعطيل الزخرفه' 
else
Text = '\n🚫┋ بالتاكيد تم تعطيل الزخرفه'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل الزخرفه' and Manager(msg) then   
if not database:get(bot_id..'lock:skrafa'..msg.chat_id_)  then
database:set(bot_id..'lock:skrafa'..msg.chat_id_) 
Text = '\n✅┋ تم تفعيل الزخرفه' 
else
